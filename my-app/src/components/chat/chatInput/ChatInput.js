...
export const ChatInput = ({messageAreaRef}) => {
    ...
    const handleSubmit = (e) => {
        ...
        setMensagem("");
        // Scroll after updating the messages state
    ...
    return(
        <form className={styles.forumlario} onSubmit={handleSubmit}>
            <input type="text" value={mensagem} className={styles.textInput} onChange={(e) => {setMensagem(e.target.value)}}></input>
